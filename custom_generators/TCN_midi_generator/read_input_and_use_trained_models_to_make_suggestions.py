            ...
            if blacks[q] == i:
                if blacks[q] > 0:
                    if blacks_intensities[q]>0 and blacks_intensities[q]<50:
                        pygame.draw.rect(surface, (0,255,0), [23 + (i * 35) + (skip_count * 35), 0, 24, 200], 4, 4)
                    if blacks_intensities[q]>50 and blacks_intensities[q]<150:
                        pygame.draw.rect(surface, (255,0,0), [23 + (i * 35) + (skip_count * 35), 0, 24, 200], 4, 4)
                    if blacks_intensities[q]>150:
                        pygame.draw.rect(surface, (0,0,255), [23 + (i * 35) + (skip_count * 35), 0, 24, 200], 4, 4)
    ...
    for i in range(len(whites)):
        if whites[i] > 0:
            ...
            if whites_intensities[i]>0 and whites_intensities[i]<50:
                    pygame.draw.rect(surface, (0,255,0), [j * 35, 200, 35, 100], 4, 4)
            if whites_intensities[i]>50 and whites_intensities[i]<150:
                    pygame.draw.rect(surface, (255,0,0), [j * 35, 200, 35, 100], 4, 4)
            if whites_intensities[i]>150:
                    pygame.draw.rect(surface, (0,0,255), [j * 35, 200, 35, 100], 4, 4)
