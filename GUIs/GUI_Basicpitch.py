#!/usr/bin/env python3
import sys, pygame, subprocess, tkinter as tk
...
SCRIPT = Path(__file__).resolve().parent.parent / "BasicPitch_transformer" / "generate_Basicpitch.py"

BASE_DIR       = Path(__file__).resolve().parent.parent
DEFAULT_INPUT  = BASE_DIR/"common_data_space"/"input_data"/"BasicPitch"/"song2_cutted.wav"
DEFAULT_OUTPUT = BASE_DIR/"common_data_space"/"generated_data"/"BasicPitch"
