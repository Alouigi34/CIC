...
SCRIPT        = Path(__file__).resolve().parent.parent / "DDSP_transformer" / "generate_DDSP.py"
...
DEFAULT_INPUT    = BASE_DIR/"common_data_space"/"input_data"/"DDSP"/"song2_cutted.wav"
DEFAULT_OUTPUT   = BASE_DIR/"common_data_space"/"generated_data"/"DDSP"
